    ...
    <main id='Home' className='min-h-screen w-screen  bg-gray-500'>
      <div className='h-10 w-full flex fixed justify-between items-center p-5 bg-amber-300/80 '>
        ...
        <div className='flex justify-center items-center gap-3 relative border px-3 py-1 rounded-md '>
          <span ref={navSlide} className='h-6 w-15 absolute left-0 px-1 rounded bg-gray-300/70 '></span>
          <a onMouseEnter={move} className='nav-link z-1' href="#Home">Home</a>
          <a onMouseEnter={move} className='nav-link z-1' href="#About">About</a>
          <a onMouseEnter={move} className='nav-link z-1' href="#Project">Project</a>
          <a onMouseEnter={move} className='nav-link z-1' href="#Contact">Contact</a>
        </div>
        <div>Let's Talk</div>
      </div>
    </main>
